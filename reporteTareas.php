<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html">Admin-Task</a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="desarrolladores.php">Desarrolladores</a>
        ...
        <li class="nav-item droptown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="reporteDesarrolladores.php">Desarrolladores</a>
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <?php
                ...
                $listado = mysqli_query($conn, "select * from tareas");
                if (!$listado) {
