        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Reporte de Tareas Asignadas</div>
            <div class="card-body">
            ...
            <?php
                ...
                $listado = mysqli_query($conn, "select idAsignacion,
                                                       (select nombre from proyectos where idproyecto = AT.idproyecto) Proyecto,
                                                       (select nombre from tareas where idtarea = AT.idtarea) Tarea,
                                                       (select nombre from contadores where idcontador = AT.idcontador) Contador,
	                                                   HorasEstimadas,
	                                                   Comentarios
